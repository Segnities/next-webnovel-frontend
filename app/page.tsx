...
import DiscoverNovels from "@/components/discover-novels";
...
export default async function Home() {
    const resDiscNovels = await fetch('http://localhost:4178/novels/discover', {cache: 'no-store'});
    
    const discoverNovels: DiscoverNovel[] = await resDiscNovels.json()
    console.log(discoverNovels);
            ...
            <BgLayout>
                <div className="flex flex-col items-center">
                    <div className="w-[98vw] lg:w-[90vw]">
                        <ContainerOffset>
                            <DiscoverNovels data={discoverNovels} slidesPerViewDefault={8}/>
                        </ContainerOffset>
                        <div className="mt-6">
                            <ContainerOffset>
                                <ContinueReading/>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8">
                                ...
                                <div className="flex flex-col gap-y-5 p-3 md:p-1 lg:p-0">
                                    <section className="mt-3">
                                        <h2 className="font-medium text-base dark:text-silver">Новини <span
                                            className="ml-2 text-sm"><ArrowRight/></span></h2>
                                        <ContainerOffset>
                                            <NewsList/>
                                        </ContainerOffset>
                                    </section>
                                    <section>
                                        <h2 className="font-medium text-base dark:text-silver">Остані відгуки <span
                                            className="ml-2 text-sm"><ArrowRight/></span></h2>
                                        <LatestReviewsList/>
                                    </section>
                                    <section>
                                        <h2 className="font-medium text-base dark:text-silver">Новинки <span
                                            className="ml-2 text-sm"><ArrowRight/></span></h2>
                                        <ContainerOffset>
